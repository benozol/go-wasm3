...
#cgo darwin,amd64,!ios,!iphonesimulator LDFLAGS: -L${SRCDIR}/lib/macosx-x86_64
#cgo darwin,arm64,!ios,!iphonesimulator LDFLAGS: -L${SRCDIR}/lib/macosx-arm64
#cgo darwin,amd64,ios,iphonesimulator   LDFLAGS: -L${SRCDIR}/lib/iphonesimulator-x86_64
#cgo darwin,arm64,ios,iphonesimulator   LDFLAGS: -L${SRCDIR}/lib/iphonesimulator-arm64
#cgo darwin,arm64,ios,!iphonesimulator  LDFLAGS: -L${SRCDIR}/lib/iphoneos-arm64
